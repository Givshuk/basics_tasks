...
if (isset($_POST['upl'])) {
    ...
    if ($errors == 0 && $uploads > 0) {
        ...
        echo 'При загрузке файлов возникли ошибки.';
    }
...
if (isset($_GET['upload'])) {
    ...
    <div class="path">
        ...
        <p>Папка назначения: <?php echo $_SERVER['DOCUMENT_ROOT'] ?>/<?php echo $p; ?> <a href="?p=<?php echo urlencode($parent) ?>"><img src="?img=arrow_up" alt=""> ..</a></p>
...
function get_file_link($p, $f)
{
    ...
    if (!empty($f)) {
        ...
        switch ($ext) {
            case 'zip':
                $link = '?p=' . urlencode($p) . '&amp;zip=' . urlencode($f);
                break;
            case 'ico':
            case 'gif':
            case 'jpg':
            ...
            case 'tiff':
            case 'psd':
                $link = '?p=' . urlencode($p) . '&amp;showimg=' . urlencode($f);
                break;
            case 'txt':
            case 'css':
            case 'ini':
            ...
            case 'twig':
            case 'tpl':
                $link = '?p=' . urlencode($p) . '&amp;showtxt=' . urlencode($f);
                break;
            default:
                $link = '';
        }
...
function get_file_icon($path)
{
    ...
    switch ($ext) {
        ...
        case 'pdf':
            ...
            break;
        case 'psd':
            $img = '?img=file_photoshop';
            break;
        case 'ai':
        case 'eps':
            $img = '?img=file_illustrator';
            break;
        case 'fla':
            $img = '?img=file_flash';
            break;
        ...
        case 'exe':
        case 'msi':
            $img = '?img=file_application';
            break;
        case 'bat':
            $img = '?img=file_terminal';
            break;
        default:
            $img = '?img=document';
    }
...
function show_navigation_path($path)
{
    ...
    <div class="path">
        <div class='float-right'>
            <a title="Загрузить файлы" href="?p=<?php echo urlencode($p) ?>&amp;upload"><img src="?img=upload"
                                                                                             alt=""></a>
